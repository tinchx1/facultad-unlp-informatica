...
public interface Graph<T> {
	 ...
	 * En caso que el vértice esté relacionado con otros, estas relaciones también
	 * se eliminan.
	 * 
	 ...
	 * Verifica que ambos vertices existan, caso contrario no realiza ninguna
	 * conexion
	 * 
	 * @param origen
	 * @param destino
	 ...
	 * Verifica que ambos vértices existan, caso contrario no realiza ninguna
	 * desconexión
	 * En caso de existir la conexión destino-->origen, esta permanecerá sin
	 * cambios.
	 * 
	 * @param origen
	 * @param destino
